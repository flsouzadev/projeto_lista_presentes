...
class PresenteFormulario(forms.Form):
    presente = forms.CharField(
        label='Insira '
    )
...
class ListaForm(forms.Form):
    ...
    area_de_servico = forms.ChoiceField(choices=AREA_DE_SERVICO_CHOICES, widget=forms.RadioSelect)
    banheiro = forms.ChoiceField(choices=BANHEIRO_CHOICES, widget=forms.RadioSelect)
    quarto = forms.ChoiceField(choices=QUARTO_CHOICES, widget=forms.RadioSelect)
    cozinha = forms.ChoiceField(choices=COZINHA_CHOICES, widget=forms.RadioSelect)
